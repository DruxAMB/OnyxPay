      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20">
        <div className="text-center">
          <h1 className="text-4xl tracking-tight font-extrabold text-white sm:text-5xl md:text-6xl">
            <span className="block">Welcome to OnyxPay</span>
            <span className="block text-purple-400">
              The Future of DeFi Yield & Payments
            </span>
          </h1>
          <p className="mt-3 max-w-md mx-auto text-base text-gray-300 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            Maximize your crypto assets with automated yield generation while managing subscription payments - all in one powerful DeFi platform.
          </p>
